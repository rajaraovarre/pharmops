          ...
          <Table>
            <TableHead>
              <TableRow sx={{ bgcolor:'primary.main' }}>
                ...
                <TableCell sx={{color:"white",fontWeight:700}}>Name</TableCell><TableCell sx={{color:"white",fontWeight:700}}>Genericname</TableCell><TableCell sx={{color:"white",fontWeight:700}}>Category</TableCell><TableCell sx={{color:"white",fontWeight:700}}>Dosageform</TableCell><TableCell sx={{color:"white",fontWeight:700}}>Strength</TableCell>
            ...
            <TableBody>
              {(data || []).map(row => (
                <TableRow key={row.id} hover>
                  ...
                  <TableCell>{row.name || "-"}</TableCell><TableCell>{row.genericName || "-"}</TableCell><TableCell>{row.category || "-"}</TableCell><TableCell>{row.dosageForm || "-"}</TableCell><TableCell>{row.strength || "-"}</TableCell>
                  <TableCell>
